...
EXTRA_PLUGINS_REPO = getenv(
    "EXTRA_PLUGINS_REPO",
    "https://github.com/qnxanjali/Extra-Plugin",
)
...
# Your User ID.
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "6260080241").split())
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/qnxanjali/Anjali",
)
...
SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL", "https://t.me/+ths-Tywxzcg2ZTFl"
)  # Example:- https://t.me/VIP_CREATORS
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "https://t.me/RBGOFFICIAL1"
...
GITHUB_REPO = getenv("GITHUB_REPO", "https://github.com/qnxanjali/Anjali")
